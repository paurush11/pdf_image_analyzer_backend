...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'pdf_analyzer'),
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        # AWS Cognito authentication will be added here
        # 'apps.core.authentication.CognitoAuthentication',
    ],
...
# pgvector Extension - will be created via migration
